...
module counter_B(enable, clk, reset, mode, D, load_B, rco_B, Q_B);
  wire [3:0] _000_;
  wire _001_;
  wire _002_;
  wire [31:0] _003_;
  ...
  assign _006_[0] = Q_B[0] | _021_[1];
  assign _023_ = _006_[0] | _006_[1];
  assign _024_ = _007_[0] | _006_[1];
  assign _007_[0] = _003_[0] | Q_B[1];
  assign _025_ = _007_[0] | _008_[1];
  assign _008_[1] = _021_[2] | Q_B[3];
  ...
  assign _018_[0] = Q_B[0] | Q_B[1];
  assign _018_[1] = Q_B[2] | Q_B[3];
  ...
  assign _043_ = _062_ ? _042_ : rco_B;
  assign _052_ = _063_ ? _051_ : load_B;
  assign _057_[0] = _062_ ? _056_[0] : Q_B[0];
  assign _057_[1] = _062_ ? _056_[1] : Q_B[1];
  assign _057_[2] = _062_ ? _056_[2] : Q_B[2];
  assign _057_[3] = _062_ ? _056_[3] : Q_B[3];
  assign _032_ = ~reset;
  always @(posedge clk)
      Q_B[0] <= _000_[0];
  always @(posedge clk)
  ...
  always @(posedge clk)
      rco_B <= _002_;
  assign _065_ = _021_[1] & Q_B[0];
  assign _061_[2] = Q_B[2] & _061_[1];
  assign _061_[1] = Q_B[1] | _065_;
  assign _064_[1] = Q_B[1] & _064_[0];
  assign _066_ = _021_[2] & _064_[1];
  assign _064_[0] = Q_B[0] | _003_[0];
  assign _064_[2] = Q_B[2] | _066_;
  assign _060_[1] = Q_B[1] & Q_B[0];
  assign _060_[2] = Q_B[2] & _060_[1];
  assign _021_[3] = Q_B[3] ^ 1'b1;
  ...
  assign _021_[1] = Q_B[1] ^ 1'b1;
  assign _004_[1] = _021_[1] ^ Q_B[0];
  assign _004_[2] = Q_B[2] ^ _061_[1];
  assign _004_[3] = Q_B[3] ^ _061_[2];
  assign _021_[2] = Q_B[2] ^ 1'b1;
  assign _059_[0] = _003_[0] ^ 1'b1;
  assign _059_[1] = Q_B[1] ^ _064_[0];
  assign _059_[2] = _021_[2] ^ _064_[1];
  assign _059_[3] = _021_[3] ^ _064_[2];
  assign _003_[0] = Q_B[0] ^ 1'b1;
  assign _003_[1] = Q_B[1] ^ Q_B[0];
  assign _003_[2] = Q_B[2] ^ _060_[1];
  assign _003_[3] = Q_B[3] ^ _060_[2];
endmodule
