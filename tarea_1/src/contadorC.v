...
module counter_C(enable, clk, reset, mode, D, load_C, rco_C, Q_C);
  wire [3:0] _000_;
  wire _001_;
  wire _002_;
  wire [31:0] _003_;
  ...
  assign _007_[0] = Q_C[0] | _019_[1];
  assign _021_ = _007_[0] | _007_[1];
  assign _008_[0] = _003_[0] | Q_C[1];
  ...
  assign _016_[0] = Q_C[0] | Q_C[1];
  assign _016_[1] = Q_C[2] | Q_C[3];
  ...
  assign _037_ = _052_ ? _036_ : rco_C;
  assign _043_ = _053_ ? _038_ : load_C;
  assign _047_[0] = _052_ ? _046_[0] : Q_C[0];
  assign _047_[1] = _052_ ? _046_[1] : Q_C[1];
  assign _047_[2] = _052_ ? _046_[2] : Q_C[2];
  assign _047_[3] = _052_ ? _046_[3] : Q_C[3];
  assign _027_ = ~reset;
  always @(posedge clk)
      Q_C[0] <= _000_[0];
  always @(posedge clk)
  ...
  always @(posedge clk)
      rco_C <= _002_;
  assign _055_ = _019_[1] & Q_C[0];
  assign _050_[2] = Q_C[2] & _050_[1];
  assign _056_ = _019_[2] & _050_[1];
  assign _050_[1] = Q_C[1] | _055_;
  assign _054_[2] = Q_C[2] | _056_;
  assign _051_[1] = Q_C[1] & Q_C[0];
  assign _051_[2] = Q_C[2] & _051_[1];
  ...
  assign _003_[0] = Q_C[0] ^ 1'b1;
  assign _019_[1] = Q_C[1] ^ 1'b1;
  assign _003_[1] = _019_[1] ^ Q_C[0];
  assign _003_[2] = Q_C[2] ^ _050_[1];
  assign _003_[3] = Q_C[3] ^ _050_[2];
  assign _019_[2] = Q_C[2] ^ 1'b1;
  assign _019_[3] = Q_C[3] ^ 1'b1;
  assign _049_[2] = _019_[2] ^ _050_[1];
  assign _049_[3] = _019_[3] ^ _054_[2];
  assign _004_[1] = Q_C[1] ^ Q_C[0];
  assign _004_[2] = Q_C[2] ^ _051_[1];
  assign _004_[3] = Q_C[3] ^ _051_[2];
endmodule
