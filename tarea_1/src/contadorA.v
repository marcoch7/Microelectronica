...
module counter_A(enable, clk, reset, mode, D, load_A, rco_A, Q_A);
  wire [3:0] _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  reg rco_A;
  input reset;
  assign _008_[0] = Q_A[0] | _022_[1];
  assign _024_ = _008_[0] | _008_[1];
  assign _025_ = _009_[0] | _008_[1];
  assign _010_[1] = Q_A[2] | _022_[3];
  ...
  assign _009_[0] = Q_A[0] | Q_A[1];
  assign _019_[1] = Q_A[2] | Q_A[3];
  ...
  assign _046_ = _053_ ? _045_ : rco_A;
  assign _049_[0] = _053_ ? _048_[0] : Q_A[0];
  assign _049_[1] = _053_ ? _048_[1] : Q_A[1];
  assign _049_[2] = _053_ ? _048_[2] : Q_A[2];
  assign _049_[3] = _053_ ? _048_[3] : Q_A[3];
  assign _030_ = ~reset;
  ...
  always @(posedge clk or posedge reset)
    if (reset)
      ...
      rco_A <= _002_;
  assign _051_[2] = Q_A[2] & _051_[1];
  assign _051_[1] = Q_A[1] | _055_;
  assign _055_ = _022_[1] & Q_A[0];
  assign _056_ = _022_[2] & _051_[1];
  assign _054_[2] = Q_A[2] | _056_;
  assign _052_[1] = Q_A[1] & Q_A[0];
  assign _052_[2] = Q_A[2] & _052_[1];
  assign _022_[2] = Q_A[2] ^ 1'b1;
  ...
  assign _006_[0] = Q_A[0] ^ 1'b1;
  assign _022_[1] = Q_A[1] ^ 1'b1;
  assign _006_[1] = _022_[1] ^ Q_A[0];
  assign _006_[2] = Q_A[2] ^ _051_[1];
  assign _006_[3] = Q_A[3] ^ _051_[2];
  assign _022_[3] = Q_A[3] ^ 1'b1;
  assign _050_[2] = _022_[2] ^ _051_[1];
  assign _050_[3] = _022_[3] ^ _054_[2];
  assign _007_[1] = Q_A[1] ^ Q_A[0];
  assign _007_[2] = Q_A[2] ^ _052_[1];
  assign _007_[3] = Q_A[3] ^ _052_[2];
endmodule
